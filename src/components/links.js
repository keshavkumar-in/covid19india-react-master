...
function Links(props) {
  return (
    <div className="Links">
      <div className="link fadeInUp" style={{animationDelay: '0.1s'}}>
        <h1>Myths & Truths Realted to COVID-19</h1>
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/izszT-YEUKw?controls=0"
          frameBorder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
          allowFullScreen
          title="Myths & Truths of COVID-19"
        ></iframe>
      </div>
